...
export default function AllWorkSpacesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new AllWorkSpaces(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "AllWorkSpacesCreateForm")}
      {...rest}
    >
      <TextField
        label="Image url"
